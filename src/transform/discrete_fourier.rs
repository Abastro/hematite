...
///
/// To perform it in-place, the ring coefficients are considered to be stored in digit-reversal order.
pub trait DFT {
    /// Ring to product
...
pub struct DFTP2 {
    pub roots_forward: Vec<Cx128>,
    pub roots_backward: Vec<Cx128>,
}
